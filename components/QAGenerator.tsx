...
export const QAGenerator: React.FC = () => {
    ...
    const handleFileChange = async (e: ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            alert("There was an error parsing one or more files. Please check the console.");
    ...
    const handleSaveVersion = () => {
        ...
        if (isEditorDirty && (!latestVersion || editorContent !== latestVersion.content)) {
    ...
    const handleDeleteVersion = (versionIdToDelete: string) => {
        ...
        if (newHistory.length === 0) {
            ...
            const deletedIndex = versionHistory.findIndex(v => v.id === versionIdToDelete);
